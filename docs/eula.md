...
1.1. By accessing or using Recalibra, you acknowledge that you have read, understood, and agree to be bound by this EULA.
1.2. If you do not agree to these terms, you must not use the App.
1.3. We may update this EULA from time to time. Continued use of the App constitutes acceptance of any changes.
...
3.1. **IMPORTANT**: Recalibra is a wellness application and is NOT a medical device.
3.2. The App provides general wellness information and exercises for relaxation and stress management.
3.3. Recalibra is NOT intended to:
...
5.1. Health data collection is optional and requires your explicit consent.
...
6.1. Recalibra may include AI-powered features for personalized recommendations.
6.2. AI recommendations are generated based on your usage patterns and preferences.
6.3. AI suggestions are not medical advice and should not replace professional consultation.
6.4. We strive for accuracy but do not guarantee the correctness of AI-generated content.
6.5. You are responsible for evaluating AI recommendations and using them at your discretion.
...
7.1. You are responsible for:
   ...
   - Using the App in a safe and appropriate manner
   - Consulting healthcare professionals before starting new wellness routines
7.2. You agree not to:
   - Use the App while driving or operating heavy machinery
   - Perform exercises that cause pain or discomfort
...
9.1. TO THE MAXIMUM EXTENT PERMITTED BY LAW, RECALIBRA IS PROVIDED "AS IS" WITHOUT WARRANTIES OF ANY KIND.
9.2. WE DISCLAIM ALL WARRANTIES, EXPRESS OR IMPLIED, INCLUDING BUT NOT LIMITED TO:
...
11.1. We may terminate or suspend your account immediately for:
   - Breach of this EULA
   - Fraudulent or illegal activities
   - Violation of app store policies
11.2. Upon termination, your right to use the App ceases immediately.
11.3. Sections 3, 5, 9, and 10 survive termination.

## 12. Governing Law and Dispute Resolution

12.1. This EULA is governed by the laws of Italy.
12.2. For EU consumers, this does not affect your mandatory consumer protection rights.
12.3. Disputes will be resolved through:
   - Good faith negotiations
   - If unresolved, through the competent court in Milan, Italy
12.4. EU consumers may use online dispute resolution platforms.

## 13. Consumer Rights (EU/Italy)

13.1. This EULA complies with:
   - EU Consumer Rights Directive
   - Italian Consumer Code (Codice del Consumo)
   - GDPR requirements
13.2. Any ambiguous or unclear terms will be interpreted in your favor as a consumer.
13.3. Unfair contract terms are not enforceable.
...
15.1. This EULA constitutes the entire agreement between you and us regarding the use of Recalibra.
15.2. If any provision is found to be unenforceable, the remaining provisions remain in full effect.
15.3. Our failure to enforce any right does not waive our ability to enforce it later.
